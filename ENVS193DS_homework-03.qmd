...
**To examine the influence of specific leaf area (SLA), water treatment, and species on biomass, I created 5 models to represent a null model, and total biomass as a function of the three predictor variables mentioned above. **
...
# Create a leaflet map centered around the specified location
map <- leaflet() %>%
  setView(lng = longitude, lat = latitude, zoom = 10) %>%
  addTiles() # Add a tile layer for the base map

# Add a marker at the specified location
map <- addMarkers(map, lng = longitude, lat = latitude, popup = "Isla Vista")
